...
#define AD_I_BRUSH			adc_result[1]
#define AD_HEATNTC			adc_average[2]
#define AD_HWDUST			adc_average[3]

#define AD_V_CHGR			adc_average[4]
#define AD_V_BAT			adc_average[5]
#define AD_I_HEAT			adc_average[6]
#define AD_L_PHOTO			adc_average[7]
#define AD_R_PHOTO			adc_average[8]
