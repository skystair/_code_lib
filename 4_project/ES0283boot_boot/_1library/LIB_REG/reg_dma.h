...
# define  DMA_IT_CH5DONE_POS 5U
# define  DMA_IT_CH5DONE_MSK BIT(DMA_II_CH5DONE_POS)
# define  DMA_IT_CH5DONE     DMA_II_CH5DONE_MSK

# define  DMA_II_CH4DONE_POS 4U
# define  DMA_II_CH4DONE_MSK BIT(DMA_II_CH4DONE_POS)
# define  DMA_II_CH4DONE     DMA_II_CH4DONE_MSK

# define  DMA_IT_CH3DONE_POS 3U
# define  DMA_IT_CH3DONE_MSK BIT(DMA_II_CH3DONE_POS)
# define  DMA_IT_CH3DONE     DMA_II_CH3DONE_MSK

# define  DMA_II_CH2DONE_POS 2U
# define  DMA_II_CH2DONE_MSK BIT(DMA_II_CH2DONE_POS)
# define  DMA_II_CH2DONE     DMA_II_CH2DONE_MSK

# define  DMA_IT_CH1DONE_POS 1U
# define  DMA_IT_CH1DONE_MSK BIT(DMA_II_CH1DONE_POS)
# define  DMA_IT_CH1DONE     DMA_II_CH1DONE_MSK
