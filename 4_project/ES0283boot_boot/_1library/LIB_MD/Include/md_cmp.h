...
#define MD_CMP_CFG1_INNSEL_ONE_FOUR_Vres_src     (0x00000000UL)       /*!< @brief 000:1/4 Vres_src */
#define MD_CMP_CFG1_INNSEL_ONE_TWO_Vres_src      (0x00000001UL)       /*!< @brief 001:1/2 Vres_src */
#define MD_CMP_CFG1_INNSEL_THREE_FOUR_Vres_src   (0x00000002UL)       /*!< @brief 010:3/4 Vres_src */
#define MD_CMP_CFG1_INNSEL_Vres_src              (0x00000003UL)       /*!< @brief 011:Vres_src     */
...
#define MD_CMP_CFG2_INNSEL_ONE_FOUR_Vres_src     (0x00000000UL)       /*!< @brief 000:1/4 Vres_src */
#define MD_CMP_CFG2_INNSEL_ONE_TWO_Vres_src      (0x00000001UL)       /*!< @brief 001:1/2 Vres_src */
#define MD_CMP_CFG2_INNSEL_THREE_FOUR_Vres_src   (0x00000002UL)       /*!< @brief 010:3/4 Vres_src */
#define MD_CMP_CFG2_INNSEL_Vres_src              (0x00000003UL)       /*!< @brief 011:Vres_src     */
...
/**
  ...
  *         @arg MD_CMP_CFG1_INNSEL_ONE_FOUR_Vres_src
  *         @arg MD_CMP_CFG1_INNSEL_ONE_TWO_Vres_src
  *         @arg MD_CMP_CFG1_INNSEL_THREE_FOUR_Vres_src
  *         @arg MD_CMP_CFG1_INNSEL_Vres_src
...
/**
  ...
  * @param  cmp CMP Instance
  * @param  blanksel This parameter can be one of the following values:
  *         @arg MD_CMP_CFG2_INNSEL_ONE_FOUR_Vres_src
  *         @arg MD_CMP_CFG2_INNSEL_ONE_TWO_Vres_src
  *         @arg MD_CMP_CFG2_INNSEL_THREE_FOUR_Vres_src
  *         @arg MD_CMP_CFG2_INNSEL_Vres_src
