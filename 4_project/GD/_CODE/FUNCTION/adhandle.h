...
#define BRUSH_I_03A0	372	//0.10*3/3.3*4095
#define BRUSH_I_03A5	434	//0.10*3.5/3.3*4095
#define BRUSH_I_05A		620	//0.10*5/3.3*4095
#define BRUSH_I_06A		744	//0.10*6/3.3*4095
#define BRUSH_I_07A		867	//0.10*8/3.3*4095
#define BRUSH_I_08A		992	//0.10*/3.3*4095
...
#define BAT_V_LOW1		2097	//18.56 batcap计算10.99%
...
#define CHG_CUT_I		149		//1.2*0.1/3.3*4095
...
extern void adfun_DSG(void);
extern void adfun_CHG(void);
#endif
