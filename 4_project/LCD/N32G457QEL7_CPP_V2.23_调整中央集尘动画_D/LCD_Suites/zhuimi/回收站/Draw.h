...
#define SOFTWARE_VERSION_NUMBER	"21"/*软件版本号*/
...
typedef enum
{
	...
	LanguageOptions_Max = LanguageOptions_Hebrew,
...
public:
	...
	void CleanScreenBuffer(void);
	void RefreshToScreen(void);
...
protected:
	...
	union
	{
		struct
		{
			...
			unsigned int ChangeLangeuage	:1;//发生预研切换 修改为最新的语言
...
private:
	...
	void RecordRunningTime(unsigned char workState);
