...
bool ListInsert(SQlist *SQlistX ,unsigned int i ,Elemtype e);	//4.插入元素
bool ListDelete(SQlist *SQlistX ,unsigned int i ,Elemtype *e);	//5.删除元素

unsigned int LocateElem(SQlist *SQlistX ,Elemtype e);			//6.按值查找位置
Elemtype GetElem(SQlist *SQlistX ,unsigned int i);				//7.按位置查找值
...
//5=========================================================================
bool ListDelete(SQlist *SQlistX ,unsigned int i ,Elemtype *e){
	if(i >= SQlistX->length){
		return false;
	}
	*e = SQlistX->data[i];
...
//6=========================================================================
unsigned int LocateElem(SQlist *SQlistX ,Elemtype e){
	unsigned int i;
...
//7=========================================================================
Elemtype GetElem(SQlist *SQlistX ,unsigned int i){
	if(i < SQlistX->length){
