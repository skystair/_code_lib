...
/**
  * @brief  Disable write access the Independent Watchdog
  * @note   if the hardware watchdog option is selected
  * @param  IWDTx IWDT Instance
  * @retval None
  */
...
{
    WRITE_REG(IWDT->BKKR, IWDT_KEY_WR_ACCESS_DISABLE);
}
/**
  * @}
  */
...
/**
  * @brief  Get IWDT BKPR Register
  * @param  IWDTx IWDT Instance
  * @retval None
  */
__STATIC_INLINE uint32_t md_iwdt_get_bkpr(IWDT_TypeDef *IWDTx)
{
