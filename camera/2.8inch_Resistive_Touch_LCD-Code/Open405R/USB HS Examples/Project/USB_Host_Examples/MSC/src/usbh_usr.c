...
void USBH_USR_DeviceDisconnected (void)
{
  ...
  lcd_display_string_line( LCD_PIXEL_HEIGHT - 42, "                                      ");
  lcd_display_string_line( LCD_PIXEL_HEIGHT - 30, "                                      ");  
...
void USBH_USR_EnumerationDone(void)
{
  ...
  lcd_display_string_line( LCD_PIXEL_HEIGHT - 42, "To see the root content of the disk : " );
  lcd_display_string_line( LCD_PIXEL_HEIGHT - 30, "Press USER KEY...                  ");
...
int USBH_USR_MSC_Application(void)
{
  ...
  case USH_USR_FS_WRITEFILE:
    ...
    lcd_set_text_color(Green);
    lcd_display_string_line( LCD_PIXEL_HEIGHT - 42, "                                              ");
    lcd_display_string_line( LCD_PIXEL_HEIGHT - 30, "Press USER KEY to write file");
    lcd_set_text_color(LCD_LOG_DEFAULT_COLOR); 
    ...
    lcd_set_text_color(Green);
    lcd_display_string_line( LCD_PIXEL_HEIGHT - 42, "                                              ");
    lcd_display_string_line( LCD_PIXEL_HEIGHT - 30, "To start Image slide show Press USER KEY.");
    lcd_set_text_color(LCD_LOG_DEFAULT_COLOR); 
  ...
  if (res == FR_OK) {
    while(HCD_IsDeviceConnected(&USB_OTG_Core)) 
    {
      ...
      if(line_idx > 9)
      {
        ...
        lcd_set_text_color(Green);
        lcd_display_string_line( LCD_PIXEL_HEIGHT - 42, "                                              ");
        lcd_display_string_line( LCD_PIXEL_HEIGHT - 30, "Press USER KEY to continue...");
        lcd_set_text_color(LCD_LOG_DEFAULT_COLOR); 
