...
void lcd_draw_rect(uint16_t Xpos, uint16_t Ypos, uint8_t Width, uint16_t Height);
void lcd_draw_full_rect(uint16_t Xpos, uint16_t Ypos, uint16_t Width, uint16_t Height);
/**
  * @}
  */ 
